...
static void InitRemainderBuffer(UINT nCyclesRemaining)
{
	...
	//note: don't know why nCyclesRemaining can be > g_nRemainderBufferSize

	for(g_nRemainderBufferIdx=0; (g_nRemainderBufferIdx<nCyclesRemaining) && (g_nRemainderBufferIdx < g_nRemainderBufferSize-1); g_nRemainderBufferIdx++)
